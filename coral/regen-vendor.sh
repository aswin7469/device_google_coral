...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.biometrics.face@1.0-service.google"
    ...
    "etc/init/android.hardware.biometrics.face@1.0-service.google.rc"
    ...
    "etc/vintf/manifest/manifest_face.xml"
